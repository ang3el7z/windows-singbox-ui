...
## Что НЕ вшивается (используются системные шрифты Windows)

**Шрифты для текста берутся из Windows:**
- **Segoe UI** - основной шрифт для текста интерфейса (системный шрифт Windows)
- **Consolas / Courier New** - моноширинные шрифты для логов (системные шрифты Windows)

Эти шрифты доступны во всех современных версиях Windows (10/11), поэтому их не нужно вшивать в приложение.
