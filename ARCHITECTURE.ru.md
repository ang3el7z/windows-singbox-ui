...
### ui/utils/
- **animations.py** - Анимации переходов между страницами
  - Анимации слайда для переходов между страницами

- **responsive_layout.py** - Помощники для адаптивных layout'ов
  - Класс `ResponsiveLayoutHelper` - помощники для создания адаптивных layout'ов
  - Вычисление размеров виджетов и кнопок на основе размера окна

- **responsive_scaler.py** - Система адаптивного масштабирования
  - Класс `ResponsiveScaler` - масштабирует все элементы UI пропорционально размеру окна
  - Масштабирование размера шрифта, минимального и максимального размеров
